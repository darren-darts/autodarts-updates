...
CATALOGUE: list[dict[str, Any]] = [
    ...
    },
    {
        "slug": "donkey-derby",
        "name": "Donkey Derby",
        "tagline": "Race your donkey home. Doubles trot, trebles gallop.",
        "category": "Party",
        "min_players": 2,
        "max_players": 8,
        "art": "derby",
        "rules": [
            "Every player gets a donkey and their own number.",
            "Hit your number to move your donkey forward one step.",
            "A double moves you two steps, a treble moves you three.",
            "The bullseye is a wildcard - it moves you one step whatever your number is.",
            "First donkey past the finish post wins the race.",
        ],
        "difficulties": {
